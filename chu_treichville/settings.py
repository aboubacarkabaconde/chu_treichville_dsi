...
ROOT_URLCONF = 'chu_treichville.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.core.context_processors.user_service',
...
WSGI_APPLICATION = 'chu_treichville.wsgi.application'

# Dans settings.py, remplace DATABASES par :
DATABASES = {
    'default': {
